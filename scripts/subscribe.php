...
<title>Communicating Partners: subscribe
</title>
<!-- MacDonald1php.html -->
...
?>
<p>Subscribing to our mailing list enables us to send you occaisional messages and to alert you of upcoming events. Your email address will not be 
provided to any one else.  Thank you for letting us keep you posted!
</p>   

<?php
echo "<form action=\"" . $_SERVER['PHP_SELF'] . "\" method=\"post\" onsubmit=\"return validate(this)\" >";
?>
<fieldset><legend>Subscribe to the newsletter!</legend>
<div class="row"><label accesskey="N" for="FirstName">First Name </label><input id="FirstName" size="40" name="FirstName_required_alphabetic" /> 
</div>
<div class="row"><label accesskey="N" for="LastName"> Last Name </label><input id="LastName" size="40" name="LastName_required_alphabetic" /> 
</div>
<div class="row"><label for="EmailAddress">Email Address </label><input id="EmailAddress" size="40" name="Email_required_email" />

<div class="row"><lable for "ListNumber">List</label>
<select size="0" name="ListNumber">
<option value="1">Standard List</option>
<option value="2">Test List</option>
</select 
</div>
