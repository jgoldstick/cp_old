...
<title>Communicating Partners: Upload File
</title>
<!-- MacDonald1php.html -->
...
if (isset($_POST['submit'])){
	$uploaddir = "/home/cp/www/MailingFiles/";
	...
	if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadfile)) {
		echo "$f was successfully uploaded.  <a href=\"Mailings.php\" >To send a mailing click here</a>\n";
	}
	else {
		$ec = $_FILES['userfile']['error'];
		echo "$f could not be uploaded: Error: $ErrorCode[$ec]";
	}
...
?>
<form enctype="multipart/form-data" action="" method="post" name="formUploadFile"> 
<fieldset><legend>Copy File To Website</legend>
<input type="hidden" name="MAX_FILE_SIZE" value="3000000" />
<div class="row"><label for="userfile">File:<input id ="userfile" name="userfile" type="file" /></label>
</div>
